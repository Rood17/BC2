...
public class ImageAdvice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_image_advice);

        //Set Data
        DataLy = (LinearLayout) findViewById(R.id.image_advice);
        setImageAdvice();
    ...
    public void setImageAdvice(){
        ...
        String[] data_part_1;
        data_part_1 = this.getResources().getStringArray(R.array.image_advice);
